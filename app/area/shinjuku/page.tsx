...
const FAQS = [
  ...
  {
    q: "新宿で「ノンアダルト一本」で続けたい場合、どこを選べばいいですか？",
    a: "新宿店舗のある大手はアダルトもノンアダルトも扱うところがほとんどです。アダルトを勧められる心配を完全になくしたい場合は、ノンアダルト専門のフェアリーテイル新宿店が最も安心です。アダルトもノンアダルトも扱う事務所を選ぶ場合は、面談時に「ノンアダルトで続けたい」と伝えて即答してくれる事務所を選んでください。",
  },
];

// 新宿で働ける主要事務所の比較データ（公式サイトと口コミから整理）
const SHINJUKU_OFFICES = [
  { name: "フェアリーテイル", slug: "ft", nonAdult: "◎専門", support: "高", area: "新宿店あり・ノンアダルト専門", target: "アダ勧誘ゼロ希望", top: true, unique: false },
  ...
  return (
    <>
      ...
      >
        ...
        <p>新宿駅周辺で通勤できる主要事務所を、<strong>「ノンアダルト専門度」「サポート密度」「新宿の特徴」「向いている人」</strong>で整理しました。<MarkerSpan>横スクロールで全列見られます</MarkerSpan>。</p>
        ...
        <h3>⑤ ノンアダルト方針の徹底度</h3>
        <p>「ノンアダルト選択可」と「ノンアダルト専門」では、<strong>面談・入店後の空気感が全く違います</strong>。「ノンアダルトで続けたい」という希望を伝えた時の反応で、その事務所の方針が見えるんです。</p>
