  ...
  return (
    <main>
      ...
      <article className="col-article-body">
        ...
        <h3>① 駅からの動線を必ず確認する</h3>
        <p>渋谷は人通りが多い分、<MarkerSpan>店舗の出入りで知り合いに会うリスク</MarkerSpan>があります。<strong>メイン通りに面した店舗より、裏通りや住宅街にある店舗</strong>の方が、人目につきにくく安心です。応募前に、店舗の最寄り駅・徒歩時間・改札からの動線を必ず確認してください。</p>
