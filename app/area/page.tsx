...
export const metadata = {
  ...
  description: "新宿・渋谷・池袋・錦糸町・上野・福岡・横浜・大宮・大阪/梅田・名古屋のエリア別にチャットレディ事務所を比較。各エリアの特性と評価が高い事務所をお伝えします。",
};
...
const areas = [
  ...
  },
  {
    ...
    summary: "渋谷駅周辺に20店舗以上が集積する激戦区。アクセス抜群で関東圏全域から通える。20代前半〜後半のキャストが中心で、清楚系から華やか系まで幅広く活躍。",
    storeCount: "20店舗以上",
  ...
  },
  {
    ...
    name: "横浜",
    icon: "⚓",
    image: "/area-yokohama.jpg",
    catchphrase: "神奈川最大のターミナル",
    summary: "横浜駅周辺にチャトレ事務所が集積。神奈川県全域・湘南方面からのアクセス良好。落ち着いた港町の雰囲気で、20-30代キャストが多めのエリア。",
    storeCount: "15店舗前後",
    target: "神奈川・湘南エリア在住の方",
  },
  {
    slug: "omiya",
    name: "大宮",
    icon: "🚉",
    image: "/area-omiya.jpg",
    catchphrase: "埼玉カバーの主要拠点",
    summary: "大宮駅周辺にチャトレ事務所が集中。新幹線・JR・私鉄が乗り入れるターミナルで、埼玉県全域・北関東からアクセス可能。事務所数は控えめだが、大手の主要事務所はカバー。",
    storeCount: "8店舗前後",
    target: "埼玉・北関東在住の方",
  },
  {
    ...
    name: "大阪/梅田",
    icon: "🏙️",
    image: "/area-osaka.jpg",
    catchphrase: "関西最大の市場",
    summary: "梅田・難波を中心に関西最大級の事務所数。大阪府全域・京都・神戸からのアクセス良好。関東とは違う「関西特有のフレンドリーな客層」が特徴。",
    storeCount: "50店舗以上",
    target: "関西在住の方",
  },
  {
    ...
    name: "名古屋",
    icon: "🏯",
    image: "/area-nagoya.jpg",
    catchphrase: "中部最大の集積エリア",
    summary: "栄・名駅周辺に事務所が集中。中部地方全域からアクセス可能で、愛知・岐阜・三重・静岡西部の方が通えるエリア。落ち着いた客層が多め。",
    storeCount: "30店舗以上",
    target: "中部・東海地方在住の方",
  },
];
