...
export const ARTICLES: Article[] = [
  { href: "/yougo/houshu-60",  category: "お金の話", title: "報酬率「最大60%」って本当？数字でわかる、安心できる事務所選び", readTime: "約3分", date: "2026.06.23", accent: "#D5A93C", image: "/top-hero-photo.jpg" /* 仮：専用カバー差し替え推奨 */ },
