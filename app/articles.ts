...
export const ARTICLES: Article[] = [
  ...
  { href: "/style/honki", category: "働き方", title: "最初の3か月が大事｜お話だけで稼ぐロードマップ", readTime: "約7分", date: "2026.06.28", accent: "#6FA858", image: "/3か月ロードマップ.jpg" },
  { href: "/q/mibare-taisaku", category: "身バレ",   title: "身バレのよくある疑問に、ぜんぶ答えます", readTime: "約6分", date: "2026.05.06", accent: "#E89B85", image: "/身バレ.png" },
];
