...
const ARTICLES: Article[] = [
  {
    ...
    excerpt: "「なんとなく良さそう」で選ぶと後悔します。安全な事務所を見極める5つの基準を、現役チャットレディの視点で解説します。",
    time: "5分", date: "2026.06.19",
    image: "/事務所選び.png",
    featured: true,
  },
  {
  ...
  {
    href: "/q/shigoto-naiyou",
    cat: "初心者・選び方",
    title: "チャットレディの仕事内容って実際どんな感じ？　1日の流れ・話す内容を正直に",
    excerpt: "「実際なにをするの？」に、現役4年・元保育士のみなみが正直に。通勤の1日の流れ、話す内容、会話が続かないときのこと、始め方まで。地味な現実もふくめてお伝えします。",
    time: "7分", date: "2026.07.18",
    image: "/仕事内容.jpg",
  },
  {
    href: "/q/barebure",
  ...
  },
  {
    ...
    excerpt: "アダルト強要・ノルマ・怪しい事務所の見分け方を、現役チャットレディ4年の視点で正直に解説。",
    time: "5分", date: "2026.06.24",
    image: "/怪しい危ない.png",
  },
  {
    href: "/q/man100",
    cat: "お金・稼ぎ方",
    title: "チャットレディで月収100万はなんだかあやしい…どんな人が届くのか正直に",
    excerpt: "求人に並ぶ「月収100万」は本当？　どんな人が届くのかを、稼働時間・常連さん・改善力に分けて、現役チャットレディ4年が正直に解説。",
    time: "8分", date: "2026.07.04",
    image: "/月収100万って本当？.jpg",
  },
];
