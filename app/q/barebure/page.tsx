      ...
      >
        <article className="col-article-body">
          ...
          <TipBox title="この記事でわかること">
            <CleanList
              items={[
                ...
                "顔の隠し方はこんなに選べる（マスク・部分顔出し・ウィッグ・メイク・フィルター・バーチャル）",
                "背景の映り込みで気をつけるもの",
                "声は「別人キャラ」を作ると身バレ対策＋人気の一石二鳥",
          ...
          <TipBox title="顔まわりの選択肢（軽いものから）">
            <CleanList
              items={[
                <>マスクやアイマスクで顔の一部を隠す。待機中は口元から下だけ映して、2ショットのときだけ顔を出す、という設定も選べます。</>,
                <>ウィッグで髪型・髪色を変える。地毛がショートならロング、黒髪なら明るい色にするだけでも、印象は大きく変わります。</>,
                <>メイクを普段と変える。カラコン・つけまつげ・メガネ、ふだんない場所のホクロメイクも効果的です。</>,
                <>配信のビューティーフィルターで、肌や目元・輪郭の印象を調整する。別人にする必要はありません。</>,
                <>プロフィール写真も、顔を全部は出さない・見切れさせる。</>,
                <>顔を一切映したくないなら、バーチャル配信でアバターと声だけ、という選び方もあります。</>,
              ]}
            />
          </TipBox>
          <p>
            メイク＋ウィッグ＋マスクのように重ねると、かなり近い人でも気づきにくくなります。事務所によっては、店舗にウィッグの貸し出しもあります。
          </p>
