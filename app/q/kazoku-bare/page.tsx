...
export const metadata = {
  ...
  description:
    "チャットレディが家族・親・彼氏にバレるのが不安な方へ。身近な人は配信そのものより“いつもと違う行動”で気づきます。画面・SNS・行動・声の押さえどころと、聞かれたときの自然な答え方、同居・同棲でも安心な方法を、現役4年のみなみがやさしく解説します。",
};
...
export default function QKazokuBare() {
  return (
    <>
      <ArticleSchema
        title="チャットレディは家族や彼氏にバレる？　よくある原因とバレない対策"
        description="身近な人は配信そのものより“いつもと違う行動”で気づきます。画面・SNS・行動・声の押さえどころと、聞かれたときの自然な答え方、同居・同棲でも安心な方法を、現役4年のみなみがやさしく解説します。"
      ...
      >
        <article className="col-article-body">
          ...
          <p>
            ...
            がきっかけです。裏返せば、画面・SNS・行動・声という「自分の手元」を自然に保つだけで防げます。お客さんに偶然見つかる話より、ずっとコントロールしやすいんです。現役4年の私、みなみも、家族と程よい距離を保ちながら続けています。順番に見ていきましょうね。
          </p>
          ...
          <div className="col-article-warn">
            ※本記事は一般的な情報提供・公開情報・現役4年の経験をもとに作成しています。サイトや事務所の対応は変わることがあるため、最新は各サイト・面接でご確認ください。
          </div>
        </article>
      </L3ArticleShell>
    </>
