...
export const metadata = {
  ...
  description:
    "チャットレディの面接って何をするの？ 応募から面接・体験入店までの流れ、持ち物、聞かれること、こちらが聞いて見極めるポイントを、元保育士で現役チャットレディ4年のみなみが正直に解説。落とす試験ではないので、怖がらなくて大丈夫です。",
};
    ...
    <>
      ...
      >
        <article className="col-article-body">
          ...
          <ReadAlso href="/q/ayashii">チャットレディは怪しい？危ない？4年目の現役チャットレディが正直に答えます</ReadAlso>
          <p>
          ...
          <ul>
            ...
            <li><Link href="/q/ayashii">チャットレディは怪しい？危ない？4年目の現役チャットレディが正直に答えます</Link></li>
            <li><Link href="/q/hoikushi-baito">チャットレディは職場にバレる？　元保育士が教える、バレない副業の始め方</Link></li>
          </ul>

          <div className="col-article-warn">
            ※本記事は一般的な情報提供・公開情報・現役チャットレディ4年（元保育士）の経験をもとに作成しています。面接の流れ・持ち物・体験入店の内容は事務所により異なるため、最新は各お店・面接でご確認ください。
          </div>
        </article>
      </L3ArticleShell>
    </>
