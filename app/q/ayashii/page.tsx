...
const FAQS = [
  {
    ...
    a: "仕事自体は合法で、適切なお店を選べば危険はありません。怪しいのは一部の悪質な事務所です。お金を先に払わせる・運営会社情報が無い・退会手続きが不明、といったサインのあるお店を避ければ大丈夫です。",
  },
  {
        ...
        <article className="col-article-body">
          ...
          <PointBox title="この記事でわかること">
            <ul style={{ margin: 0, paddingLeft: 18, lineHeight: 1.9 }}>
              ...
              <li>本当に危ない事務所を見分ける具体サイン（詐欺の前払い等）</li>
          ...
          <h2>本当に危ない事務所を、見分けるサイン</h2>
          <p>ここがいちばん大事。危ないお店は確かにありますが、<strong>サインは決まっています。</strong></p>

          <WarningBox title="こんなお店は要注意">
            ・<strong>お金を「先に」払わせる</strong>（登録料・ポイント代・手続き費用 等＝“稼ぐ前に払わせる”のは詐欺のサイン）<br />
            ・報酬率が極端に高い（50%以上など／国内サイトの規約上ありえない）<br />
            ・「即日入店・面談なし」で急かす<br />
            ・運営会社の住所・代表者名が公開されていない<br />
            ・退会・契約解除の手続きが書かれていない
          </WarningBox>

          <TipBox title="逆に、信頼できるサイン">
          ...
          <p>逆に言えば、このサインさえ確認できれば、怪しいお店はちゃんと避けられます。</p>
          ...
          <PointBox title="この記事のまとめ">
            ...
            □ 危ないサインは決まっている（<strong>お金を先に払わせる</strong>等）<br />
