...
export const metadata = {
  ...
  description: "初めてのチャットレディ事務所選びで失敗しないために。報酬の仕組み・サポートの見抜き方・初心者がつまずく5つのポイントと対策・始め方の流れまで、現役チャットレディ4年のみなみが正直に解説します。",
};
    ...
    <>
      ...
      >
        <article className="col-article-body">
          ...
          <p>でも、大丈夫。事務所選びは、見るところさえ分かっていれば、そんなに難しくありません。初めてのあなたが安心して選べるように、現役チャットレディ4年の私が知っていることを、正直にお話ししていきますね。</p>

          <TipBox title="この記事でわかること">
            <CleanList items={[
              "報酬の仕組み（通勤30%・在宅40%と「最大60%」のからくり）",
              "一次/二次より「ちゃんと教えてくれるか」で選ぶ理由",
              "サポートの良し悪しの見抜き方・面談で見るところ",
              "初心者がつまずく5つのポイントと対策",
              "応募〜デビューの始め方の流れ",
            ]} />
          </TipBox>
          ...
          <div className="col-article-warn">
            ※この記事は、現役チャットレディの経験と事務所スタッフから聞いた話をもとにまとめています。お店の状況は変わることがあるので、最終的にはご自身で確認してくださいね。
          </div>
