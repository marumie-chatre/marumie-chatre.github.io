...
const OFFICE_DATA: OfficeDetailData = {
  ...
  story: {
    ...
    paragraphs: [
      "ポケットワークは在宅メインの大手で、広告では料率の高さが目立ちます。でも実際の在宅スタートは38%で、上の料率に上がるには条件がある——これは業界を見てきた私の実感でもあり、寄せられた口コミでも似た声がいくつもありました。",
      "「思った以上に稼働しないと、上の料率には届かなかった」「在宅は通勤よりサポートが薄くて、ひとりで頑張る覚悟がいる」。そんな声が重なっています。【数字の大きさより、その条件をちゃんと確かめること】。広告の印象と、入ってからの実感がずれることもあるんだな、と感じます。",
    ],
  },
  basic: [
