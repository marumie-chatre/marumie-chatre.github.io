...
const OFFICE_DATA: OfficeDetailData = {
  ...
  tags: ["アダルトもあり", "寮あり", "大手", "未経験歓迎", "24時間スタッフ", "全国対応", "ボーナスあり", "顔出し向き"],
  breakdown: [
    { l: "安全性", v: 25, max: 30 },
    { l: "サポート", v: 20, max: 25 },
    { l: "初心者", v: 17, max: 20 },
  ...
  honestComment: "気をつけたいのは、店舗による差が大きいこと。同じグループでも環境や扱いが変わるので、どの店舗かをよく確認してから決めてください。報酬は時給制と歩合制を選べてボーナスも多めですが、その分条件はやや複雑です。雰囲気は競争的なところもあります。それとアダルトもノンアダルトも扱うお店なので、お店の方針としてアダルトもすすめます。会話のコツより先にアダルト対応を教わる場面もあるので、ノンアダルトで続けたい人は、教え方やノンアダルトの実績を面接で確認しておくと安心です。",
  features: [
