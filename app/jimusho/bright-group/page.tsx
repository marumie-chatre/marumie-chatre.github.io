...
const OFFICE_DATA: OfficeDetailData = {
  ...
  honestComment: "気をつけたいのは、店舗による差が大きいこと。同じグループでも環境や扱いが変わるので、どの店舗かをよく確認してから決めてください。報酬は時給制と歩合制を選べてボーナスも多めですが、その分条件はやや複雑です。雰囲気は競争的なところもあります。それと両対応のお店なので、お客さんによってはアダルト寄りのお願いが来ることもあります。落ち着いてノンアダルトで続けたい人は、対応範囲を面接で確認しておくと安心です。",
  features: [
