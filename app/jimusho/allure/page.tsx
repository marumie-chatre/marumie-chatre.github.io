...
const OFFICE_DATA: OfficeDetailData = {
  ...
  honestComment: "保証やボーナスは手厚いのですが、お客さんをつかんで報酬を伸ばすノウハウの部分は、やや薄い印象です。技術もしっかり伸ばしたい人には物足りないかもしれません。保証や祝い金で選ぶなら、NMRグループやポケットワークと見比べてもいいと思います。入ってから分かる条件もありそうなので、日給保証の適用条件や保証適用外の額は、面接で具体的に確認してください。両対応のため、アダルト寄りのお願いが来る場面もあります。",
  features: [
