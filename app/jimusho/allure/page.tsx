...
const OFFICE_DATA: OfficeDetailData = {
  ...
  tags: ["両対応", "日給保証", "入店祝い金", "日払い対応", "面接交通費", "在宅・通勤", "明細発行", "初心者向け"],
  breakdown: [
    { l: "安全性", v: 24, max: 30 },
    { l: "サポート", v: 18, max: 25 },
    { l: "初心者", v: 13, max: 20 },
  ...
  honestComment: "保証やボーナスは手厚いのですが、お客さんをつかんで報酬を伸ばすノウハウの部分は、やや薄い印象です。技術もしっかり伸ばしたい人には物足りないかもしれません。保証や祝い金で選ぶなら、NMRグループやポケットワークと見比べてもいいと思います。入ってから分かる条件もありそうなので、日給保証の適用条件や保証適用外の額は、面接で具体的に確認してください。両対応のため、店舗の方針によってはアダルトをすすめられる場面もあります。ノンアダルトでの進め方も合わせて聞いておくと安心です。",
  features: [
