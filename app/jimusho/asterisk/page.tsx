...
const OFFICE_DATA: OfficeDetailData = {
  ...
  honestComment: "ここは高収入を前面に出したお店で、アダルト寄りの色が強めです。お客さん次第というより、アダルトをすすめられる場面が多めだと感じます。落ち着いてノンアダルトで長く続けたい人には、少しハードルが高いかもしれません。ノンアダルトで続けたいなら、面接で「そのまま続けられるか」「どのくらいすすめられるか」を必ず確認してください。細かい情報は公式サイトが中心なので、雰囲気は1日体験で確かめてください。",
  features: [
