...
const OFFICE_DATA: OfficeDetailData = {
  ...
  tags: ["両対応", "在宅・通勤切替", "ノルマ罰金なし", "完全防音個室", "機材衣装完備", "初心者向け", "店舗により月20万保証", "条件が見える"],
  breakdown: [
    { l: "安全性", v: 23, max: 30 },
    { l: "サポート", v: 18, max: 25 },
    { l: "初心者", v: 15, max: 20 },
  ...
  honestComment: "気をつけたいのは、「会社全体で見える条件」と「店舗ごとの保証条件」は別だということ。たとえば月20万円の給与保証は全店一律ではなく、保証のある店舗とない店舗があります。「どこでも20万保証」と思い込んで応募すると、ずれが出ます。気になる店舗の条件は個別に確認してください（保証の看板がはっきりしているのはアリュールです）。両対応なので、お店によってはアダルトもすすめられます。ノンアダルトのままでも稼ぐ教え方があるかを、聞いておくと安心です。",
  features: [
