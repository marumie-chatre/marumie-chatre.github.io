...
const OFFICE_DATA: OfficeDetailData = {
  ...
  honestComment: "気をつけたいのは、「会社全体で見える条件」と「店舗ごとの保証条件」は別だということ。たとえば月20万円の給与保証は全店一律ではなく、保証のある店舗とない店舗があります。「どこでも20万保証」と思い込んで応募すると、ずれが出ます。気になる店舗の条件は個別に確認してください（保証の看板がはっきりしているのはアリュールです）。両対応なので、アダルト寄りのお願いが来ることもあります。",
  features: [
