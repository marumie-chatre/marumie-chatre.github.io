...
const OFFICE_DATA: OfficeDetailData = {
  ...
  tags: ["アダルトもあり", "ノンアダルトOK", "バーチャル配信", "初回時給保証", "日払い", "初心者向け", "サポート手厚い", "在宅相談OK"],
  breakdown: [
    { l: "安全性", v: 23, max: 30 },
    { l: "サポート", v: 21, max: 25 },
    { l: "初心者", v: 17, max: 20 },
  ...
  honestComment: "アダルトもノンアダルトも扱うお店なので、店舗によってはノンアダルトより先にアダルトをすすめられることもあります。応募のときに「ノンアダルトのまま続けられるか」「会話で稼ぐ教え方をしてもらえるか」を、自分の言葉で確認しておくと安心です。顔出しなしだと報酬が少し下がる場合があると公式FAQに明記されています。隠さず書いているのは誠実ですが、高単価を最優先したい人には物足りないかもしれません。掛け持ちは基本NGとされている点も、先に知っておいてください。",
  features: [
  ...
  story: {
    title: "載せられないけれど、伝えたい温かさ",
    paragraphs: [
      "いただいた口コミの中には、そのまま載せるとお店やスタッフ、ご本人が特定されてしまいそうで、個人情報保護のためにあえて省いたエピソードもあります。そのひとつが、思わずクスッとする温かい話でした。詳しい中身は伏せますが、配信の待機中のちょっとした場面まで、スタッフが親身に声をかけて、一緒に盛り上げてくれた——そんなエピソードです。",
      "待機が長くなると、つい気持ちがゆるむ時ってありますよね。そこまで寄り添って、一緒に楽しんでくれるスタッフがいるんだ、と思うと和みます。【「サポートが近い」って、こういう小さな場面に出る】んですよね。",
    ],
  },
  basic: [
    ["ジャンル", "アダルト・ノンアダルトの両方"],
