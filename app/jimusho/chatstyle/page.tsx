...
const OFFICE_DATA: OfficeDetailData = {
  ...
  honestComment: "両対応のお店なので、店舗によってはノンアダルトより先にアダルトをすすめられることもあります。応募のときに「ノンアダルトのまま続けられるか」「会話で稼ぐ教え方をしてもらえるか」を、自分の言葉で確認しておくと安心です。顔出しなしだと報酬が少し下がる場合があると公式FAQに明記されています。隠さず書いているのは誠実ですが、高単価を最優先したい人には物足りないかもしれません。掛け持ちは基本NGとされている点も、先に知っておいてください。",
  features: [
