...
const FAQS = [
  {
    ...
    a: "できます。自分の入れる時間に合わせて短時間から始められ、副業として帰宅後のスキマ時間に少しだけという方も多いです。お客さんが多い時間帯（一般に夜22〜翌1時ごろ）に、決まった時間で入ると効率的です。",
  },
  {
    q: "どのくらい稼げますか？",
      ...
      >
        ...
        <article className="col-article-body">
          ...
          <TipBox title="短い時間でも効くこと">
            ...
            来てくれた人へ<strong>お礼のメッセージ</strong>を一人ずつ（数より丁寧さ）<br />
            <strong>常連さん</strong>を少しずつ増やす（一見を追いかけ続けない）<br />
            サムネイル写真と待機中の表情を整えておく（入ってもらえる入口）
          </TipBox>
          ...
          <PointBox title="副業に通勤がおすすめな理由">
            <strong>気持ちの切り替え</strong>がしやすい（家だと家事や誘惑でつい後回しに）<br />
            短い時間でも<strong>その場でコツを教われる</strong>（限られた時間を無駄にしない）<br />
          ...
          <TipBox title="ありがちなつまずき">
            ...
            「すぐ稼げる」に惹かれて選んだら、立ち上がりの遅さに焦ってやめた
          </TipBox>
