...
export default function StyleNonAdultPage() {
  ...
  return (
    <>
      <ArticleSchema
        title="ノンアダルトは本当にお話だけ？サポート・収入と安心の選び方"
        description="「ノンアダルトはお話だけで稼げる」って本当？お話だけで働ける仕組みの本当のところと、収入・サポートのリアル、安心して選ぶコツを、現役4年のみなみが正直に解説します。"
      ...
      >
        ...
        <article className="col-article-body">
          ...
          <p>だからこそ、現役4年の私が正直にお話しします。<MarkerSpan>結論から言うと、“お話だけ”で働く仕組みは本当にあります。</MarkerSpan>ただし、お店によって中身がちがうので、その見分け方まで、まるごとお伝えしますね。</p>
